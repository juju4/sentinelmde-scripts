...
In short, when you submit code changes, your submissions are understood to be under the same [License](/LICENSES) that covers the project. Feel free to contact the maintainers if that's a concern.
